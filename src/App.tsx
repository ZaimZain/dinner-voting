...
const RESTAURANTS: Restaurant[] = [
  {
    ...
    name: "Olive & Ember",
    description:
      "Cozy seasonal plates, wood-fired flavors, & warm cocktails.",
    images: [
  ...
  },
  {
    ...
    name: "Harbor Bistro",
    description:
      "Fresh seafood, waterfront views and elevated classics.",
    images: [
  ...
  },
  {
    ...
    name: "Garden Table",
    description:
      "Vegetable-forward tasting menu with creative pairings.",
    images: [
